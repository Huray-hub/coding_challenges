// Package insertanodeataspecificpositioninalinkedlist contains solution for hackerrank problem https://www.hackerrank.com/challenges/insert-a-node-at-a-specific-position-in-a-linked-list
package insertanodeataspecificpositioninalinkedlist
...
func main() {
	...
	llistHead := insertNodeAtPosition(llist.head, data, position)

	printSinglyLinkedList(llistHead, " ", writer)
	fmt.Fprintf(writer, "\n")

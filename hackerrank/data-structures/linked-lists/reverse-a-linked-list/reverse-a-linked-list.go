// Package reversealinkedlist contains solution for hackerrank problem https://www.hackerrank.com/challenges/reverse-a-linked-list/problem
...
func reverse(llist *SinglyLinkedListNode) *SinglyLinkedListNode {
	...
	var previousNode, temp *SinglyLinkedListNode
	currentNode := llist
